...
for(const [branch,entries] of Object.entries(branches)){
  ...
  for(const entry of entries){
    ...
    for(const marker of ['Official civilian crosswalk starting points','Your rank changes the story','directions worth exploring','Reality check:']) if(!html.includes(marker)) errors.push(`${rel}: missing ${marker}`);
