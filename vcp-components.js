...
(function () {
  ...
  function initBackToTop() {
    ...
    btn.style.cssText = 'position:fixed;bottom:84px;right:24px;width:44px;height:44px;border-radius:50%;background:linear-gradient(135deg,#c8960a,#e8aa10);color:#0a1628;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 16px rgba(200,150,10,.3);opacity:0;transform:translateY(20px);transition:all .3s cubic-bezier(.4,0,.2,1);z-index:1000;';
